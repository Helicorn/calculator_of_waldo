...
export function LolFreeBoardDetailPage({ boardId }: LolFreeBoardDetailPageProps) {
  ...
  async function handleCommentSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const url = `${BACKEND_BASE_URL}/api/waldo/games/lol/board/${boardId}/comments`;
            ...
            <section className="flex flex-col gap-3">
              ...
              <form onSubmit={handleCommentSubmit} className="flex flex-col gap-2">
                <div className="flex flex-row items-stretch gap-2">
                  <label htmlFor="lol-board-detail-comment" className="sr-only">
                    댓글 입력
                  </label>
                  <textarea
                    id="lol-board-detail-comment"
                    value={commentDraft}
